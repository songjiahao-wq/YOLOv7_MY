...
```shell
python export.py --weights yolov7_MY-tiny.pt --grid --end2end --simplify \
...
python export.py --weights ./yolov7_MY-tiny.pt --grid --end2end --simplify --topk-all 100 --iou-thres 0.65 --conf-thres 0.35 --img-size 640 640
git clone https://github.com/Linaom1214/tensorrt-python.git
python ./tensorrt-python/export.py -o yolov7_MY-tiny.onnx -e yolov7_MY-tiny-nms.trt -p fp16
```
...
```shell
wget https://github.com/WongKinYiu/yolov7/releases/download/v0.1/yolov7-tiny.pt
python export.py --weights yolov7_MY-tiny.pt --grid --include-nms
git clone https://github.com/Linaom1214/tensorrt-python.git
python ./tensorrt-python/export.py -o yolov7_MY-tiny.onnx -e yolov7_MY-tiny-nms.trt -p fp16

# Or use trtexec to convert ONNX to TensorRT engine
/usr/src/tensorrt/bin/trtexec --onnx=yolov7_MY-tiny.onnx --saveEngine=yolov7_MY-tiny-nms.trt --fp16
```
