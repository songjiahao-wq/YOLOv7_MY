...
# 原始路径
image_original_path = r'D:\songjiahao\DATA\smokke\VOC\AUG2\images/'
label_original_path = r'D:\songjiahao\DATA\smokke\VOC\AUG2\labels/'
# 复制文件总路径
src_root = r'D:\songjiahao\DATA\smokke\VOC\AUG2\smoke_AUGyolo'
# 训练集路径
